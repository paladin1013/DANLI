...
while True:
    game_id = input("Please input game id to check the prompt and response: ")

    if game_id in gpt_sessions:
        print(f"Prompt:\n\n{gpt_sessions[game_id].prompts[0]}\n\nResponse:\n\n{gpt_sessions[game_id].replies[0]}")
    else:
        print(f"Game id {game_id} does not exist!")